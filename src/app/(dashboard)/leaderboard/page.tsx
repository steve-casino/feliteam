...
import { mockLeaderboardEntries, mockUserBadges } from '@/lib/mock-data'
...
const LeaderboardPage: React.FC = () => {
  ...
  // Use first user as "current user" for highlighting
  ...
  const getUserBadges = (userId: string) => {
    return mockUserBadges
      ...
      .map((ub) => BADGE_DEFS.find((b) => b.id === ub.badge_id))
      .filter(Boolean)
  }
