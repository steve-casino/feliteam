...
const TeamPage: React.FC = () => {
  ...
  const getPostTypeColor = (type: PostType) => {
    const colors = {
      announcement: 'bg-blue-600/20 text-blue-400',
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="ml-auto px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-600/50 disabled:cursor-not-allowed text-white rounded-lg font-medium flex items-center gap-2 transition-colors"
                >
